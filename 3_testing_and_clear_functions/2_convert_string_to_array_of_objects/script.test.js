describe('Convert string to array of objects', () => {
  describe('sumCharsCode', () => {
    ...
    describe('with invalid input data', () => {
      it ('[]', () => {
        assert.throw(function() { sumCharsCode([]) }, Error, /It is not a String/)
      });
      it ('123', () => {
        assert.throw(function() { sumCharsCode(123) }, Error, /It is not a String/)
      });
      it ("null", () => {
        assert.throw(function() { sumCharsCode(123) }, Error, /It is not a String/)
  ...
  describe('wordStat', () => {
    ...
    describe('with invalid input data', () => {
      it ('[]', () => {
        assert.throw(function() { wordStat([]) }, Error, /It is not a String/)
      });
      it ('123', () => {
        assert.throw(function() { wordStat(123) }, Error, /It is not a String/)
      });
      it ("null", () => {
        assert.throw(function() { wordStat(123) }, Error, /It is not a String/)
